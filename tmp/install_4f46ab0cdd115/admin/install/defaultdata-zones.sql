...
(411, 26, 'TAR', 'Tarija'),
(412, 27, 'RS', 'Republika Srpska'),
(413, 27, 'BRO', 'Brčko District'),
(414, 27, 'FUS', 'Unsko-Sanski Kanton'),
(415, 27, 'FPO', 'Posavski Kanton'),
(416, 27, 'FTU', 'Tuzlanski Kanton'),
(417, 27, 'FZE', 'Zeničko-Dobojski Kanton'),
(418, 27, 'FBP', 'Bosanskopodrinjski Kanton'),
(419, 27, 'FSB', 'Srednjebosanski Kanton'),
(420, 27, 'FHN', 'Hercegovačko-neretvanski Kanton'),
(421, 27, 'FZH', 'Zapadnohercegovački Kanton'),
(422, 27, 'FSA', 'Kanton Sarajevo'),
(423, 27, 'FZA', 'Zapadnobosanski Kanton'),
(430, 28, 'CE', 'Central'),
(431, 28, 'GH', 'Ghanzi'),
(432, 28, 'KD', 'Kgalagadi'),
(433, 28, 'KT', 'Kgatleng'),
...
(901, 56, 'J', 'Vysocina'),
(902, 56, 'Z', 'Zlinsky'),
(903, 57, 'HS', 'Hovedstaden'),
(904, 57, 'MJ', 'Midtjylland'),
(905, 57, 'ND', 'Nordjylland'),
(906, 57, 'SL', 'Sjælland'),
(907, 57, 'SD', 'Syddanmark'),
(908, 57, 'FO', 'Faroe Islands'),
(909, 57, 'GL', 'Greenland'),
(919, 58, 'S', 'Ali Sabih'),
(920, 58, 'K', 'Dikhil'),
(921, 58, 'J', 'Djibouti'),
...
(1091, 73, '42', 'Alsace'),
(1092, 73, '72', 'Aquitaine'),
(1093, 73, '83', 'Auvergne'),
(1094, 73, '53', 'Bretagne'),
(1095, 73, '26', 'Bourgogne'),
(1096, 73, '24', 'Centre'),
(1097, 73, '21', 'Champagne-Ardennes'),
(1098, 73, '94', 'Corse'),
(1099, 73, '43', 'Franche-Comté'),
(1100, 73, '91', 'Languedoc-Roussillon'),
(1101, 73, '74', 'Limousin'),
(1102, 73, '41', 'Lorraine'),
(1103, 73, '73', 'Midi-Pyrénées'),
(1104, 73, '31', 'Nord-Pas-de-Calais'),
(1105, 73, '25', 'Basse-Normandie'),
(1106, 73, '11', 'Île-de-France'),
(1107, 73, '22', 'Picardie'),
(1108, 73, '54', 'Poitou-Charentes'),
(1109, 73, '93', 'Provence-Alpes-Côte d''Azur'),
(1110, 73, '82', 'Rhône-Alpes'),
(1111, 73, '23', 'Haute-Normandie'),
(1112, 73, '52', 'Pays-de-la-Loire'),
(1113, 74, 'Et', 'Etranger'),
(1114, 74, '01', 'Ain'),
(1115, 74, '02', 'Aisne'),
(1116, 74, '03', 'Allier'),
...
(2135, 136, 'CC', 'Cargados Cara#_ Shoals (Saint Brandon Islands)'),
...
(3850, 105, 'BA', 'Bari'),
(3851, 105, 'BT', 'Barletta-Andria-Trani'),
(3852, 105, 'BL', 'Belluno'),
(3853, 105, 'BN', 'Benevento'),
(3854, 105, 'BG', 'Bergamo'),
(3855, 105, 'BI', 'Biella'),
(3856, 105, 'BO', 'Bologna'),
(3857, 105, 'BZ', 'Bolzano'),
(3858, 105, 'BS', 'Brescia'),
(3859, 105, 'BR', 'Brindisi'),
(3860, 105, 'CA', 'Cagliari'),
(3861, 105, 'CL', 'Caltanissetta'),
(3862, 105, 'CB', 'Campobasso'),
(3863, 105, 'CI', 'Carbonia-Iglesias'),
(3864, 105, 'CE', 'Caserta'),
(3865, 105, 'CT', 'Catania'),
(3866, 105, 'CZ', 'Catanzaro'),
(3867, 105, 'CH', 'Chieti'),
(3868, 105, 'CO', 'Como'),
(3869, 105, 'CS', 'Cosenza'),
(3870, 105, 'CR', 'Cremona'),
...
(3877, 105, 'FG', 'Foggia'),
(3878, 105, 'FC', 'Forl'),
(3879, 105, 'FR', 'Frosinone'),
(3880, 105, 'GE', 'Genova'),
(3881, 105, 'GO', 'Gorizia'),
(3882, 105, 'GR', 'Grosseto'),
(3883, 105, 'IM', 'Imperia'),
(3884, 105, 'IS', 'Isernia'),
(3885, 105, 'SP', 'La Spezia'),
(3886, 105, 'AQ', 'L''Aquila'),
(3887, 105, 'LT', 'Latina'),
(3888, 105, 'LE', 'Lecce'),
(3889, 105, 'LC', 'Lecco'),
(3890, 105, 'LI', 'Livorno'),
(3891, 105, 'LO', 'Lodi'),
(3892, 105, 'LU', 'Lucca'),
(3893, 105, 'MC', 'Macerata'),
(3894, 105, 'MN', 'Mantova'),
(3895, 105, 'MS', 'Massa-Carrara'),
(3896, 105, 'MT', 'Matera'),
(3897, 105, 'ME', 'Messina'),
(3898, 105, 'MI', 'Milano'),
(3899, 105, 'MO', 'Modena'),
(3900, 105, 'MB', 'Monza e della Brianza'),
(3901, 105, 'NA', 'Napoli'),
(3902, 105, 'NO', 'Novara'),
(3903, 105, 'NU', 'Nuoro'),
(3904, 105, 'OT', 'Olbia-Tempio'),
(3905, 105, 'OR', 'Oristano'),
(3906, 105, 'PD', 'Padova'),
(3907, 105, 'PA', 'Palermo'),
(3908, 105, 'PR', 'Parma'),
(3909, 105, 'PV', 'Pavia'),
(3910, 105, 'PG', 'Perugia'),
(3911, 105, 'PU', 'Pesaro e Urbino'),
(3912, 105, 'PE', 'Pescara'),
(3913, 105, 'PC', 'Piacenza'),
(3914, 105, 'PI', 'Pisa'),
(3915, 105, 'PT', 'Pistoia'),
(3916, 105, 'PN', 'Pordenone'),
(3917, 105, 'PZ', 'Potenza'),
(3918, 105, 'PO', 'Prato'),
(3919, 105, 'RG', 'Ragusa'),
(3920, 105, 'RA', 'Ravenna'),
(3921, 105, 'RC', 'Reggio Calabria'),
(3922, 105, 'RE', 'Reggio Emilia'),
(3923, 105, 'RI', 'Rieti'),
(3924, 105, 'RN', 'Rimini'),
(3925, 105, 'RM', 'Roma'),
(3926, 105, 'RO', 'Rovigo'),
(3927, 105, 'SA', 'Salerno'),
(3928, 105, 'VS', 'Medio Campidano'),
(3929, 105, 'SS', 'Sassari'),
(3930, 105, 'SV', 'Savona'),
(3931, 105, 'SI', 'Siena'),
(3932, 105, 'SR', 'Siracusa'),
(3933, 105, 'SO', 'Sondrio'),
(3934, 105, 'TA', 'Taranto'),
(3935, 105, 'TE', 'Teramo'),
(3936, 105, 'TR', 'Terni'),
(3937, 105, 'TO', 'Torino'),
(3938, 105, 'OG', 'Ogliastra'),
(3939, 105, 'TP', 'Trapani'),
(3940, 105, 'TN', 'Trento'),
(3941, 105, 'TV', 'Treviso'),
(3942, 105, 'TS', 'Trieste'),
...
(3944, 105, 'VA', 'Varese'),
(3945, 105, 'VE', 'Venezia'),
(3946, 105, 'VB', 'Verbano-Cusio-Ossola'),
(3947, 105, 'VC', 'Vercelli'),
(3948, 105, 'VR', 'Verona'),
...
(3955, 240, 'JI', 'Južna i Istočna Srbija'),
(3956, 240, 'KM', 'Kosovo i Metohija'),
(3957, 241, 'AN', 'Andrijevica'),
(3958, 241, 'BA', 'Berane'),
(3959, 241, 'BD', 'Budva'),
(3960, 241, 'BP', 'Bijelo Polje'),
(3961, 241, 'BR', 'Bar'),
(3962, 241, 'CT', 'Cetinje'),
(3963, 241, 'DG', 'Danilovgrad'),
(3964, 241, 'HN', 'Herceg Novi'),
(3965, 241, 'KL', 'Kolašin'),
(3966, 241, 'KO', 'Kotor'),
(3967, 241, 'MK', 'Mojkovac'),
(3968, 241, 'NK', 'Nikšić'),
(3969, 241, 'PG', 'Podgorica'),
(3970, 241, 'PL', 'Plav'),
(3971, 241, 'PŽ', 'Plužine'),
(3972, 241, 'PV', 'Pljevlja'),
(3973, 241, 'RO', 'Rožaje'),
(3974, 241, 'ŠN', 'Šavnik'),
(3975, 241, 'TV', 'Tivat'),
(3976, 241, 'UL', 'Ulcinj'),
